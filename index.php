...
<body class="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100">
        ...
        <div class="max-w-7xl mx-auto px-6 py-4">
            <div class="flex justify-between items-center">
                ...
                <div class="hidden md:flex space-x-8">
                    <a href="index.php" class="text-blue-600 font-bold transition duration-300 flex items-center space-x-2 border-b-2 border-blue-600">
    ...
    <main class="relative z-10 px-6 py-8 flex-grow flex items-center justify-center">
        <div class="rounded-3xl shadow-custom w-full max-w-xl p-10 text-center animate-slideInUp glass-effect border border-gray-100">
                ...
                (status === 'success' ? 'alert-success' :
                    status === 'error' ? 'alert-danger' :
                        status === 'warning' ? 'alert-warning' :
                            'text-gray-700 bg-gray-50'); // Default or info
